...
const PROGRESS_CONTAINER_HEIGHT = 6;
...
export function ProgressBar(props: ProgressBarProps) {
	...
	return (
		<div className="mb-6">
			...
			<div ref={ref} className={`relative h-[${PROGRESS_CONTAINER_HEIGHT}px] bg-background-variant`}>
				<h6 className={`absolute bottom-0 right-0 m-0 mb-[${PROGRESS_CONTAINER_HEIGHT}px] py-0.5 px-3 text-text bg-background-variant`}>{progress}%</h6>
				<span
